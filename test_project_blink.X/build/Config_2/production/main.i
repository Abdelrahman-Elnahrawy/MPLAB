...
# 1 "./include/Spi_Types.h" 1



# 1 "./include/../include/Std_Types.h" 1
# 15 "./include/../include/Std_Types.h"
...
# 1 "./include/../config/Spi_Cfg.h" 1




# 1 "./include/../config/../config/Spi_Cfg.h" 1
# 5 "./include/../config/../config/Spi_Cfg.h" 2
...
int main (void){
    ...
    Spi_Init(&Spi_Configurations);


    while (1){


        receivedData = Spi_TransmitReceive(0xFF);
