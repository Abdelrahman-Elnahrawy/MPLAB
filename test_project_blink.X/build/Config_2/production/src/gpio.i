...
# 1 "src/../config/Gpio_Cfg.h" 1
# 17 "src/../config/Gpio_Cfg.h"
# 1 "src/../config/../include/Std_Types.h" 1
# 15 "src/../config/../include/Std_Types.h"
...
# 17 "src/../config/Gpio_Cfg.h" 2

# 1 "src/../config/../include/Gpio_Types.h" 1
# 17 "src/../config/../include/Gpio_Types.h"
typedef enum {
    GPIO_PIN_LOW = 0,
    GPIO_PIN_HIGH
} Gpio_PinStateType;
...
uint8 Gpio_Init(const Gpio_ConfigType* ConfigPtr) {
    ...
    for (uint8 i = 0; i < 6; i++) {
        ...
        switch (function) {
            ...
            case GPIO_PIN0_AN0:
                if (pinNumber != 0) return (Std_ReturnType)1;
                ANSEL |= (1 << 0);
                TRISIO |= (1 << 0);
                break;
            ...
            case GPIO_PIN1_AN1:
                if (pinNumber != 1) return (Std_ReturnType)1;
                ANSEL |= (1 << 1);
                TRISIO |= (1 << 1);
                break;
            ...
            case GPIO_PIN2_AN2:
                if (pinNumber != 2) return (Std_ReturnType)1;
                ANSEL |= (1 << 2);
                TRISIO |= (1 << 2);
                break;
            ...
            case GPIO_PIN3_MCLR:
                if (pinNumber != 3) return (Std_ReturnType)1;
            ...
            case GPIO_PIN4_AN3:
                if (pinNumber != 4) return (Std_ReturnType)1;
                ANSEL |= (1 << 3);
                TRISIO |= (1 << 4);
                break;
            case GPIO_PIN4_T1G:
            ...
            case GPIO_PIN5_T1CKI:
                if (pinNumber != 5) return (Std_ReturnType)1;
                T1CON |= (1 << 1);
                break;
            case GPIO_PIN5_OSC1:
                if (pinNumber != 5) return (Std_ReturnType)1;
