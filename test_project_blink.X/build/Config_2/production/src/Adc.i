...
# 1 "src/Adc.c" 2
# 15 "src/Adc.c"
# 1 "src/../include/Adc.h" 1
# 19 "src/../include/Adc.h"
# 1 "src/../include/../include/Adc_Types.h" 1
# 18 "src/../include/../include/Adc_Types.h"
# 1 "src/../include/Std_Types.h" 1
# 15 "src/../include/Std_Types.h"
...
# 18 "src/../include/../include/Adc_Types.h" 2
...
# 19 "src/../include/Adc.h" 2

# 1 "src/../include/../config/Adc_Cfg.h" 1
# 90 "src/../include/../config/Adc_Cfg.h"
typedef struct {
...
uint8 Adc_Init(const Adc_ConfigType* ConfigPtr) {
    ...
    (ADCON0 &= ~(0b1 << 6)); (ADCON0 |=(0 << 6));


(ANSEL &= ~(0b111 << 4) ); (ANSEL |= (( ((2000000 / ((4000000)/1000 )) >= 1600) ? 0b000 : ((4000000 / ((4000000)/1000 )) >= 1600) ? 0b100 : ((8000000 / ((4000000)/1000 )) >= 1600) ? 0b001 : ((16000000 / ((4000000)/1000 )) >= 1600) ? 0b101 : ((32000000 / ((4000000)/1000 )) >= 1600) ? 0b010 : ((64000000 / ((4000000)/1000 )) >= 1600) ? 0b110 : 0b110) << 4) );
    ...
    if (!(
       (ConfigPtr->channel == ADC_CHANNEL_AN0 && (ANSEL & (1 << 0))) ||
       (ConfigPtr->channel == ADC_CHANNEL_AN1 && (ANSEL & (1 << 1))) ||
       (ConfigPtr->channel == ADC_CHANNEL_AN2 && (ANSEL & (1 << 2))) ||
...
uint8 Adc_StartConversion(Adc_ChannelType channel) {
        ...
        if (!(
       (channel == ADC_CHANNEL_AN0 && (ANSEL & (1 << 0))) ||
       (channel == ADC_CHANNEL_AN1 && (ANSEL & (1 << 1))) ||
       (channel == ADC_CHANNEL_AN2 && (ANSEL & (1 << 2))) ||
...
uint16 Adc_ReadResult(void) {
    ...
    if (ADCON0 & (1 << 7)) {
        ...
        return (uint16)((ADRESH << 2) | (ADRESL >> 6));
    }
}
