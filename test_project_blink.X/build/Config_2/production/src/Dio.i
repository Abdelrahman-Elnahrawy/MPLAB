...
# 1 "src/Dio.c" 2
# 15 "src/Dio.c"
# 1 "src/../include/Dio.h" 1
# 18 "src/../include/Dio.h"
# 1 "src/../include/../include/Dio_Types.h" 1
# 18 "src/../include/../include/Dio_Types.h"
...
# 18 "src/../include/../include/Dio_Types.h" 2
...
# 18 "src/../include/Dio.h" 2

# 1 "src/../include/../config/Dio_Cfg.h" 1
# 24 "src/../include/../config/Dio_Cfg.h"
typedef struct {
...
# 1 "src/../include/gpio.h" 1
# 17 "src/../include/gpio.h"
# 1 "src/../include/../config/Gpio_Cfg.h" 1
# 18 "src/../include/../config/Gpio_Cfg.h"
# 1 "src/../include/../config/../include/Gpio_Types.h" 1
# 17 "src/../include/../config/../include/Gpio_Types.h"
typedef enum {
    GPIO_PIN_LOW = 0,
    GPIO_PIN_HIGH
} Gpio_PinStateType;
...
# 18 "src/../include/../config/Gpio_Cfg.h" 2
...
uint8 Dio_Init(const Dio_ConfigType* ConfigPtr) {
    ...
    for (uint8 i = 0; i < 6; i++) {
        ...
        if (ConfigPtr[i].PinDirection != DIO_NOT_APPLICABLE) {
            ...
            if (!(
                (ConfigPtr[i].pinNumber == 0 && (ANSEL & (1 << 0))) ||
                (ConfigPtr[i].pinNumber == 1 && (ANSEL & (1 << 1))) ||
                (ConfigPtr[i].pinNumber == 2 && (ANSEL & (1 << 2))) ||
