...
# 2 "<built-in>" 2
# 1 "config/Adc_Lcfg.c" 2
# 15 "config/Adc_Lcfg.c"
# 1 "config/Adc_Cfg.h" 1
# 18 "config/Adc_Cfg.h"
# 1 "config/../include/Adc_Types.h" 1
# 18 "config/../include/Adc_Types.h"
...
# 18 "config/../include/Adc_Types.h" 2
...
const Adc_ConfigType Adc_Configurations[] = {
    {ADC_CHANNEL_AN0, ADC_RESULT_LEFT},
    {ADC_CHANNEL_AN1, ADC_RESULT_LEFT},
    {ADC_CHANNEL_AN2, ADC_RESULT_LEFT},
    {ADC_CHANNEL_AN3, ADC_RESULT_LEFT}
};
