...
void max7219_init() {
    send_to_max7219(0x0F, 0x00);
    send_to_max7219(0x0B, 0x03);
    send_to_max7219(0x09, 0x0F);
    send_to_max7219(0x0A, 0x08);
    send_to_max7219(0x0C, 0x01);
}


void display_number(int num) {
    send_to_max7219(0x01, num % 10);
    send_to_max7219(0x02, (num / 10) % 10);
    send_to_max7219(0x03, 0x0F);
    send_to_max7219(0x04, 0x0F);
}
